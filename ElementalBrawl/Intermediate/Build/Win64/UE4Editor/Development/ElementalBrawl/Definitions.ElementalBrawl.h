...
#define UE_PROJECT_NAME ElementalBrawl
#define UE_TARGET_NAME ElementalBrawlEditor
#define UE_MODULE_NAME "ElementalBrawl"
...
#define ELEMENTALBRAWL_API DLLEXPORT
