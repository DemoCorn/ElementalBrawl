...
#ifdef ELEMENTALBRAWL_FireMoveset_generated_h
#error "FireMoveset.generated.h already included, missing '#pragma once' in FireMoveset.h"
#endif
...
public: \
	DECLARE_CLASS(UFireMoveset, UMovesetParent, COMPILED_IN_FLAGS(0 | CLASS_Config), CASTCLASS_None, TEXT("/Script/ElementalBrawl"), NO_API) \
...
#define ElementalBrawl_Source_ElementalBrawl_Public_FireMoveset_h_15_STANDARD_CONSTRUCTORS \
	...
	DECLARE_VTABLE_PTR_HELPER_CTOR(NO_API, UFireMoveset); \
	DEFINE_VTABLE_PTR_HELPER_CTOR_CALLER(UFireMoveset); \
private: \
	/** Private move- and copy-constructors, should never be used */ \
	NO_API UFireMoveset(UFireMoveset&&); \
	NO_API UFireMoveset(const UFireMoveset&); \
public:
...
template<> ELEMENTALBRAWL_API UClass* StaticClass<class UFireMoveset>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID ElementalBrawl_Source_ElementalBrawl_Public_FireMoveset_h
